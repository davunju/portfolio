...
export default function Footer() {
  return (
    <footer className="relative mt-8 border-t border-zinc-200/70 bg-white/45 px-4 py-10 backdrop-blur-md dark:border-white/[0.06] dark:bg-slate-950/50 md:px-6">
